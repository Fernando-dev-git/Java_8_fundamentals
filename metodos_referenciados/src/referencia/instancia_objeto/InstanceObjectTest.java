package referencia.instancia_objeto;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;
import referencia.test.ProveedorComparaciones;
import util.Persona;

public class InstanceObjectTest {

  public static void main(String[] args) {
    ProveedorComparaciones proveedor = new ProveedorComparaciones();
    ...
    System.out.println("\nLista Ordenada Metodo Referencia por instancia");
    Collections.sort(personas, proveedor::compareToName);
    personas.forEach(p -> System.out.println(p));
    
    System.out.println("\nMetodo Referenciado de una instancia e un tipo albitrario");
